                ...
                <section className="container mx-auto px-6 py-16 md:py-24 relative z-10 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl text-gray-400 mb-8 leading-relaxed max-w-2xl mx-auto">
                            {category.description || `Discover our handpicked collection of expert ${category.name.toLowerCase()} home decor guides.`}
                        </p>
                ...
                <section className="container mx-auto px-6 pb-24 relative z-10">
                    {articles.length > 0 ? (
                                ...
                                >
                                    ...
                                    <div className="flex-1 p-6 flex flex-col relative">
                                        ...
                                        <p className="text-gray-400 text-sm mb-6 line-clamp-3">
                                            {article.excerpt || "Explore our detailed guide and discover step-by-step room styling instructions..."}
                                        </p>
                        ...
                        <div className="text-center py-20 bg-white/5 rounded-2xl border border-white/10 border-dashed">
                            ...
                            <p className="text-gray-500">We're currently preparing some amazing {category.name.toLowerCase()} home decor guides for you.</p>
                        </div>
                    )}
