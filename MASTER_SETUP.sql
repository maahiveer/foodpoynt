-- ################################################################################
-- DecorPoynt MASTER DATABASE SETUP SCRIPT
-- RUN THIS ONCE IN YOUR SUPABASE SQL EDITOR TO INITIALIZE THE ENTIRE BLOG
-- ################################################################################
...
-- 6. SECURITY POLICIES (No-Recursion Fix)
...
-- 7. AUTOMATION: AUTOMATIC PROFILE & ADMIN CREATION
...
-- 2. Since you are the first user, you will be the ADMIN automatically.
-- ################################################################################
